...
--
-- Host: localhost    Database: bdd_supermarket
-- ------------------------------------------------------
...
CREATE TABLE `tbl_ordenes` (
  ...
  `ord_fecha` datetime DEFAULT CURRENT_TIMESTAMP,
  `ord_total` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`ord_id`),
  KEY `cli_id` (`cli_id`),
  CONSTRAINT `tbl_ordenes_ibfk_1` FOREIGN KEY (`cli_id`) REFERENCES `tbl_clientes` (`cli_id`) ON DELETE CASCADE
...
-- Dump completed on 2024-12-08 20:57:20
